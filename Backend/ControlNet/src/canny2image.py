...
def load_canny():
    ...
    return apply_canny, model_canny, ddim_sampler_canny

def canny_process(input_image, prompt, a_prompt, n_prompt, num_samples, image_resolution, ddim_steps, guess_mode, strength, scale, seed, eta, low_threshold, high_threshold, apply_canny, model_canny, ddim_sampler_canny):
    num_samples = 1
    with torch.no_grad():
